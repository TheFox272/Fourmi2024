...
N_TEST=1
BASIC_PARAMS="25 25 500 0.9 0.99 5000"
OUTPUT_FILE="results/basic_tests_output.txt"
GRAPH_OUTPUT_FILE="graphs/basic_graph.png"
...
run_command "mpirun -np 1 python3 ants_display.py $BASIC_PARAMS : --oversubscribe -np 4 python3 ants_computation.py"

run_command "mpirun -np 1 python3 ants_display.py $BASIC_PARAMS : --oversubscribe -np 5 python3 ants_computation.py"
